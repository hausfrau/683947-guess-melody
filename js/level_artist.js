...
import levelGenre from './level_genre';
import artistWelcome from './welcome';

const LEVEL_ARTIST = `<section class="main main--level main--level-artist">
...
const levelArtistScreen = getElementFromTemplate(LEVEL_ARTIST);
const playAgain = levelArtistScreen.querySelector(`.play-again`);

playAgain.addEventListener(`click`, () => appendScreen(artistWelcome));
